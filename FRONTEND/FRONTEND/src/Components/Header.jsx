...
const navigation = [
  { name: 'For Startups', href: '#', current: true },
  { name: 'For Enablers', href: '#', current: false },
  { name: 'Event & Media', href: '#', current: false },
  { name: 'Ecosystem', href: '#', current: false },
  { name: 'Startup Thiruvizha24', href: '#', current: false }
]
...
export default function Header() {
  return (
    <Disclosure as="nav" className="bg-white-50">
